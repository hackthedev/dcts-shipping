...
export async function createMember({
    ...
    if (!password) throw new Error("Member password is missing when creating member.")
    if (!loginName) throw new Error("Member loginName is missing when creating member.")
