...
function openPagePopup(elementId, url){
    ...
    if(!pagePopup) {
        ...
        pagePopup.style.backgroundColor = "green";
        pagePopup.style.zIndex = "2";

        pagePopup.style.borderRadius = "4px";
...
document.addEventListener('DOMContentLoaded', openPagePopup);